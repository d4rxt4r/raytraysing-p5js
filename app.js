...
function draw() {
   ...
   const floorMat = new FlatColor(vec3(0.8, 0.8, 0.0));
   const glassMat = new Dielectric(1.5);
   const bubbleMat = new Dielectric(1 / 1.5);
   const steelMat = new Metal(vec3(0.8, 0.8, 0.8));
   const bronzeMat = new Metal(vec3(0.8, 0.6, 0.2), 0.6);

   Scene.add(new Sphere(vec3(0, -100.5, -1), 100, floorMat));
   Scene.add(new Sphere(vec3(0, 0, -1.2), 0.5, bronzeMat));
   Scene.add(new Sphere(vec3(-1, 0, -1), 0.5, glassMat));
   Scene.add(new Sphere(vec3(-1, 0, -1), 0.4, bubbleMat));
   Scene.add(new Sphere(vec3(1, 0, -1), 0.5, steelMat));
